...
var file_node_v1_node_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xfc, 0x08, 0x0a, 0x15, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x72,
...
var file_node_v1_node_proto_goTypes = []interface{}{
	...
	(*DumpRPCsRequest)(nil),                        // 29: node.v1.DumpRPCsRequest
	(*DumpRPCsResponse)(nil),                       // 30: node.v1.DumpRPCsResponse
	(*GuardianSetUpdate_Guardian)(nil),             // 31: node.v1.GuardianSetUpdate.Guardian
	nil,                                            // 32: node.v1.DumpRPCsResponse.ResponseEntry
	(*v1.ObservationRequest)(nil),                  // 33: gossip.v1.ObservationRequest
}
var file_node_v1_node_proto_depIdxs = []int32{
	...
	31, // 8: node.v1.GuardianSetUpdate.guardians:type_name -> node.v1.GuardianSetUpdate.Guardian
	33, // 9: node.v1.SendObservationRequestRequest.observation_request:type_name -> gossip.v1.ObservationRequest
	32, // 10: node.v1.DumpRPCsResponse.response:type_name -> node.v1.DumpRPCsResponse.ResponseEntry
	0,  // 11: node.v1.NodePrivilegedService.InjectGovernanceVAA:input_type -> node.v1.InjectGovernanceVAARequest
	11, // 12: node.v1.NodePrivilegedService.FindMissingMessages:input_type -> node.v1.FindMissingMessagesRequest
	13, // 13: node.v1.NodePrivilegedService.SendObservationRequest:input_type -> node.v1.SendObservationRequestRequest
	15, // 14: node.v1.NodePrivilegedService.ChainGovernorStatus:input_type -> node.v1.ChainGovernorStatusRequest
	17, // 15: node.v1.NodePrivilegedService.ChainGovernorReload:input_type -> node.v1.ChainGovernorReloadRequest
	19, // 16: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:input_type -> node.v1.ChainGovernorDropPendingVAARequest
	21, // 17: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:input_type -> node.v1.ChainGovernorReleasePendingVAARequest
	23, // 18: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:input_type -> node.v1.ChainGovernorResetReleaseTimerRequest
	25, // 19: node.v1.NodePrivilegedService.PurgePythNetVaas:input_type -> node.v1.PurgePythNetVaasRequest
	27, // 20: node.v1.NodePrivilegedService.SignExistingVAA:input_type -> node.v1.SignExistingVAARequest
	29, // 21: node.v1.NodePrivilegedService.DumpRPCs:input_type -> node.v1.DumpRPCsRequest
	2,  // 22: node.v1.NodePrivilegedService.InjectGovernanceVAA:output_type -> node.v1.InjectGovernanceVAAResponse
	12, // 23: node.v1.NodePrivilegedService.FindMissingMessages:output_type -> node.v1.FindMissingMessagesResponse
	14, // 24: node.v1.NodePrivilegedService.SendObservationRequest:output_type -> node.v1.SendObservationRequestResponse
	16, // 25: node.v1.NodePrivilegedService.ChainGovernorStatus:output_type -> node.v1.ChainGovernorStatusResponse
	18, // 26: node.v1.NodePrivilegedService.ChainGovernorReload:output_type -> node.v1.ChainGovernorReloadResponse
	20, // 27: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:output_type -> node.v1.ChainGovernorDropPendingVAAResponse
	22, // 28: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:output_type -> node.v1.ChainGovernorReleasePendingVAAResponse
	24, // 29: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:output_type -> node.v1.ChainGovernorResetReleaseTimerResponse
	26, // 30: node.v1.NodePrivilegedService.PurgePythNetVaas:output_type -> node.v1.PurgePythNetVaasResponse
	28, // 31: node.v1.NodePrivilegedService.SignExistingVAA:output_type -> node.v1.SignExistingVAAResponse
	30, // 32: node.v1.NodePrivilegedService.DumpRPCs:output_type -> node.v1.DumpRPCsResponse
