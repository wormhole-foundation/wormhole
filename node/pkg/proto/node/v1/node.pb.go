...
var file_node_v1_node_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x76, 0x61, 0x61, 0x32, 0xbb, 0x08, 0x0a, 0x15,
	...
	0x41, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74,
...
var file_node_v1_node_proto_goTypes = []interface{}{
	...
	(*WormchainMigrateContract)(nil),               // 10: node.v1.WormchainMigrateContract
	(*FindMissingMessagesRequest)(nil),             // 11: node.v1.FindMissingMessagesRequest
	(*FindMissingMessagesResponse)(nil),            // 12: node.v1.FindMissingMessagesResponse
	(*SendObservationRequestRequest)(nil),          // 13: node.v1.SendObservationRequestRequest
	(*SendObservationRequestResponse)(nil),         // 14: node.v1.SendObservationRequestResponse
	(*ChainGovernorStatusRequest)(nil),             // 15: node.v1.ChainGovernorStatusRequest
	(*ChainGovernorStatusResponse)(nil),            // 16: node.v1.ChainGovernorStatusResponse
	(*ChainGovernorReloadRequest)(nil),             // 17: node.v1.ChainGovernorReloadRequest
	(*ChainGovernorReloadResponse)(nil),            // 18: node.v1.ChainGovernorReloadResponse
	(*ChainGovernorDropPendingVAARequest)(nil),     // 19: node.v1.ChainGovernorDropPendingVAARequest
	(*ChainGovernorDropPendingVAAResponse)(nil),    // 20: node.v1.ChainGovernorDropPendingVAAResponse
	(*ChainGovernorReleasePendingVAARequest)(nil),  // 21: node.v1.ChainGovernorReleasePendingVAARequest
	(*ChainGovernorReleasePendingVAAResponse)(nil), // 22: node.v1.ChainGovernorReleasePendingVAAResponse
	(*ChainGovernorResetReleaseTimerRequest)(nil),  // 23: node.v1.ChainGovernorResetReleaseTimerRequest
	(*ChainGovernorResetReleaseTimerResponse)(nil), // 24: node.v1.ChainGovernorResetReleaseTimerResponse
	(*PurgePythNetVaasRequest)(nil),                // 25: node.v1.PurgePythNetVaasRequest
	(*PurgePythNetVaasResponse)(nil),               // 26: node.v1.PurgePythNetVaasResponse
	(*SignExistingVAARequest)(nil),                 // 27: node.v1.SignExistingVAARequest
	(*SignExistingVAAResponse)(nil),                // 28: node.v1.SignExistingVAAResponse
	(*GuardianSetUpdate_Guardian)(nil),             // 29: node.v1.GuardianSetUpdate.Guardian
	(*v1.ObservationRequest)(nil),                  // 30: gossip.v1.ObservationRequest
}
var file_node_v1_node_proto_depIdxs = []int32{
	...
	10, // 7: node.v1.GovernanceMessage.wormchain_migrate_contract:type_name -> node.v1.WormchainMigrateContract
	29, // 8: node.v1.GuardianSetUpdate.guardians:type_name -> node.v1.GuardianSetUpdate.Guardian
	30, // 9: node.v1.SendObservationRequestRequest.observation_request:type_name -> gossip.v1.ObservationRequest
	0,  // 10: node.v1.NodePrivilegedService.InjectGovernanceVAA:input_type -> node.v1.InjectGovernanceVAARequest
	11, // 11: node.v1.NodePrivilegedService.FindMissingMessages:input_type -> node.v1.FindMissingMessagesRequest
	13, // 12: node.v1.NodePrivilegedService.SendObservationRequest:input_type -> node.v1.SendObservationRequestRequest
	15, // 13: node.v1.NodePrivilegedService.ChainGovernorStatus:input_type -> node.v1.ChainGovernorStatusRequest
	17, // 14: node.v1.NodePrivilegedService.ChainGovernorReload:input_type -> node.v1.ChainGovernorReloadRequest
	19, // 15: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:input_type -> node.v1.ChainGovernorDropPendingVAARequest
	21, // 16: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:input_type -> node.v1.ChainGovernorReleasePendingVAARequest
	23, // 17: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:input_type -> node.v1.ChainGovernorResetReleaseTimerRequest
	25, // 18: node.v1.NodePrivilegedService.PurgePythNetVaas:input_type -> node.v1.PurgePythNetVaasRequest
	27, // 19: node.v1.NodePrivilegedService.SignExistingVAA:input_type -> node.v1.SignExistingVAARequest
	2,  // 20: node.v1.NodePrivilegedService.InjectGovernanceVAA:output_type -> node.v1.InjectGovernanceVAAResponse
	12, // 21: node.v1.NodePrivilegedService.FindMissingMessages:output_type -> node.v1.FindMissingMessagesResponse
	14, // 22: node.v1.NodePrivilegedService.SendObservationRequest:output_type -> node.v1.SendObservationRequestResponse
	16, // 23: node.v1.NodePrivilegedService.ChainGovernorStatus:output_type -> node.v1.ChainGovernorStatusResponse
	18, // 24: node.v1.NodePrivilegedService.ChainGovernorReload:output_type -> node.v1.ChainGovernorReloadResponse
	20, // 25: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:output_type -> node.v1.ChainGovernorDropPendingVAAResponse
	22, // 26: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:output_type -> node.v1.ChainGovernorReleasePendingVAAResponse
	24, // 27: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:output_type -> node.v1.ChainGovernorResetReleaseTimerResponse
	26, // 28: node.v1.NodePrivilegedService.PurgePythNetVaas:output_type -> node.v1.PurgePythNetVaasResponse
	28, // 29: node.v1.NodePrivilegedService.SignExistingVAA:output_type -> node.v1.SignExistingVAAResponse
