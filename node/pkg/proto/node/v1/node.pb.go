...
var file_node_v1_node_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xa9, 0x05, 0x0a, 0x11, 0x47, 0x6f, 0x76, 0x65, 0x72,
	...
	0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	...
	0x69, 0x74, 0x74, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x4f, 0x0a, 0x0f,
	...
	0x69, 0x6f, 0x6e, 0x4d, 0x73, 0x67, 0x22, 0xb4, 0x01, 0x0a, 0x1a, 0x46, 0x69, 0x6e, 0x64, 0x4d,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4f, 0x0a, 0x17, 0x50, 0x75, 0x72, 0x67, 0x65, 0x50, 0x79, 0x74,
	...
	0x3a, 0x02, 0x38, 0x01, 0x32, 0xfc, 0x08, 0x0a, 0x15, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x72, 0x69,
...
var file_node_v1_node_proto_goTypes = []interface{}{
	...
	(*WormchainStoreCode)(nil),                     // 8: node.v1.WormchainStoreCode
	(*WormchainInstantiateContract)(nil),           // 9: node.v1.WormchainInstantiateContract
	(*FindMissingMessagesRequest)(nil),             // 10: node.v1.FindMissingMessagesRequest
	(*FindMissingMessagesResponse)(nil),            // 11: node.v1.FindMissingMessagesResponse
	(*SendObservationRequestRequest)(nil),          // 12: node.v1.SendObservationRequestRequest
	(*SendObservationRequestResponse)(nil),         // 13: node.v1.SendObservationRequestResponse
	(*ChainGovernorStatusRequest)(nil),             // 14: node.v1.ChainGovernorStatusRequest
	(*ChainGovernorStatusResponse)(nil),            // 15: node.v1.ChainGovernorStatusResponse
	(*ChainGovernorReloadRequest)(nil),             // 16: node.v1.ChainGovernorReloadRequest
	(*ChainGovernorReloadResponse)(nil),            // 17: node.v1.ChainGovernorReloadResponse
	(*ChainGovernorDropPendingVAARequest)(nil),     // 18: node.v1.ChainGovernorDropPendingVAARequest
	(*ChainGovernorDropPendingVAAResponse)(nil),    // 19: node.v1.ChainGovernorDropPendingVAAResponse
	(*ChainGovernorReleasePendingVAARequest)(nil),  // 20: node.v1.ChainGovernorReleasePendingVAARequest
	(*ChainGovernorReleasePendingVAAResponse)(nil), // 21: node.v1.ChainGovernorReleasePendingVAAResponse
	(*ChainGovernorResetReleaseTimerRequest)(nil),  // 22: node.v1.ChainGovernorResetReleaseTimerRequest
	...
	(*DumpRPCsRequest)(nil),                        // 28: node.v1.DumpRPCsRequest
	(*DumpRPCsResponse)(nil),                       // 29: node.v1.DumpRPCsResponse
	(*GuardianSetUpdate_Guardian)(nil),             // 30: node.v1.GuardianSetUpdate.Guardian
	nil,                                            // 31: node.v1.DumpRPCsResponse.ResponseEntry
...
var file_node_v1_node_proto_depIdxs = []int32{
	...
	30, // 7: node.v1.GuardianSetUpdate.guardians:type_name -> node.v1.GuardianSetUpdate.Guardian
	32, // 8: node.v1.SendObservationRequestRequest.observation_request:type_name -> gossip.v1.ObservationRequest
	31, // 9: node.v1.DumpRPCsResponse.response:type_name -> node.v1.DumpRPCsResponse.ResponseEntry
	0,  // 10: node.v1.NodePrivilegedService.InjectGovernanceVAA:input_type -> node.v1.InjectGovernanceVAARequest
	10, // 11: node.v1.NodePrivilegedService.FindMissingMessages:input_type -> node.v1.FindMissingMessagesRequest
	12, // 12: node.v1.NodePrivilegedService.SendObservationRequest:input_type -> node.v1.SendObservationRequestRequest
	14, // 13: node.v1.NodePrivilegedService.ChainGovernorStatus:input_type -> node.v1.ChainGovernorStatusRequest
	16, // 14: node.v1.NodePrivilegedService.ChainGovernorReload:input_type -> node.v1.ChainGovernorReloadRequest
	18, // 15: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:input_type -> node.v1.ChainGovernorDropPendingVAARequest
	20, // 16: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:input_type -> node.v1.ChainGovernorReleasePendingVAARequest
	22, // 17: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:input_type -> node.v1.ChainGovernorResetReleaseTimerRequest
	24, // 18: node.v1.NodePrivilegedService.PurgePythNetVaas:input_type -> node.v1.PurgePythNetVaasRequest
	26, // 19: node.v1.NodePrivilegedService.SignExistingVAA:input_type -> node.v1.SignExistingVAARequest
	28, // 20: node.v1.NodePrivilegedService.DumpRPCs:input_type -> node.v1.DumpRPCsRequest
	2,  // 21: node.v1.NodePrivilegedService.InjectGovernanceVAA:output_type -> node.v1.InjectGovernanceVAAResponse
	11, // 22: node.v1.NodePrivilegedService.FindMissingMessages:output_type -> node.v1.FindMissingMessagesResponse
	13, // 23: node.v1.NodePrivilegedService.SendObservationRequest:output_type -> node.v1.SendObservationRequestResponse
	15, // 24: node.v1.NodePrivilegedService.ChainGovernorStatus:output_type -> node.v1.ChainGovernorStatusResponse
	17, // 25: node.v1.NodePrivilegedService.ChainGovernorReload:output_type -> node.v1.ChainGovernorReloadResponse
	19, // 26: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:output_type -> node.v1.ChainGovernorDropPendingVAAResponse
	21, // 27: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:output_type -> node.v1.ChainGovernorReleasePendingVAAResponse
	23, // 28: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:output_type -> node.v1.ChainGovernorResetReleaseTimerResponse
	25, // 29: node.v1.NodePrivilegedService.PurgePythNetVaas:output_type -> node.v1.PurgePythNetVaasResponse
	27, // 30: node.v1.NodePrivilegedService.SignExistingVAA:output_type -> node.v1.SignExistingVAAResponse
	29, // 31: node.v1.NodePrivilegedService.DumpRPCs:output_type -> node.v1.DumpRPCsResponse
