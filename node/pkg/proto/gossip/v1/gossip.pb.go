...
type GossipMessage struct {
	...
	//	*GossipMessage_SignedChosenVaaV1
...
func (x *GossipMessage) GetSignedChosenVaaV1() *SignedChosenVAAV1 {
	if x, ok := x.GetMessage().(*GossipMessage_SignedChosenVaaV1); ok {
		return x.SignedChosenVaaV1
	}
	return nil
}
...
type GossipMessage_SignedChosenVaaV1 struct {
	SignedChosenVaaV1 *SignedChosenVAAV1 `protobuf:"bytes,13,opt,name=signed_chosen_vaa_v1,json=signedChosenVaaV1,proto3,oneof"`
}
...
func (*GossipMessage_SignedChosenVaaV1) isGossipMessage_Message() {}

// SignedChosenVAAV1 is used as a second trigger for VAAv2 signing.
// A leader guardian sends a specific VAAv1 to all peers to gossip.
// Upon seeing a valid SignedChosenVAAV1, a guardian will inspect it against the leader's key, and if it is valid
// and the VAAv1 is correct: it will begin a TSS process.
type SignedChosenVAAV1 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SignedChosenVAAV1) Reset() {
	*x = SignedChosenVAAV1{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedChosenVAAV1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedChosenVAAV1) ProtoMessage() {}

func (x *SignedChosenVAAV1) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_v1_gossip_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedChosenVAAV1.ProtoReflect.Descriptor instead.
func (*SignedChosenVAAV1) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{1}
}

func (x *SignedChosenVAAV1) GetVaa() []byte {
	if x != nil {
		return x.Vaa
	}
	return nil
...
func (x *SignedChosenVAAV1) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_gossip_v1_gossip_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x22, 0xca, 0x06, 0x0a, 0x0d, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x4d, 0x65,
	...
	,
	...
	0x69, 0x67, 0x68, 0x74, 0x22, 0x27, 0x0a, 0x13, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x56, 0x41,
...
var file_gossip_v1_gossip_proto_goTypes = []interface{}{
	...
	(*SignedChosenVAAV1)(nil),               // 1: gossip.v1.SignedChosenVAAV1
...
var file_gossip_v1_gossip_proto_depIdxs = []int32{
	...
	1,  // 8: gossip.v1.GossipMessage.signed_chosen_vaa_v1:type_name -> gossip.v1.SignedChosenVAAV1
...
func file_gossip_v1_gossip_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gossip_v1_gossip_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedChosenVAAV1); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gossip_v1_gossip_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*GossipMessage_SignedChosenVaaV1)(nil),
	}
	type x struct{}
