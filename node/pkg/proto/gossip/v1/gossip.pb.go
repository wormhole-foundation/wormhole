...
type GossipMessage struct {
	...
	//	*GossipMessage_TssGossipMessage
...
func (x *GossipMessage) GetTssGossipMessage() *TSSGossipMessage {
	if x, ok := x.GetMessage().(*GossipMessage_TssGossipMessage); ok {
		return x.TssGossipMessage
	}
	return nil
}
...
type GossipMessage_TssGossipMessage struct {
	TssGossipMessage *TSSGossipMessage `protobuf:"bytes,13,opt,name=tss_gossip_message,json=tssGossipMessage,proto3,oneof"`
}
...
func (*GossipMessage_TssGossipMessage) isGossipMessage_Message() {}

// TSSGossipMessage is used to forward different TSS messages between nodes.
// For instance: in the TSS protocol we incorporated a leader-based protocol where a specific guardian
// can forward a VAAv1 with a specific committee it wants others to participate in.
type TSSGossipMessage struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// currently marshalled VAAv1. Can later be other items signers wish to gossip about.
	Message []byte `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	// ECDSA signature using the node's guardian public key.
	Signature []byte `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`
}

func (x *TSSGossipMessage) Reset() {
	*x = TSSGossipMessage{}
	if protoimpl.UnsafeEnabled {
...
func (x *TSSGossipMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TSSGossipMessage) ProtoMessage() {}

func (x *TSSGossipMessage) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_v1_gossip_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TSSGossipMessage.ProtoReflect.Descriptor instead.
func (*TSSGossipMessage) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{1}
}

func (x *TSSGossipMessage) GetMessage() []byte {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *TSSGossipMessage) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (*Heartbeat_Network) Descriptor() ([]byte, []int) {
	return file_gossip_v1_gossip_proto_rawDescGZIP(), []int{3, 0}
}
...
var file_gossip_v1_gossip_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x22, 0xc6, 0x06, 0x0a, 0x0d, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x4d, 0x65,
	...
	0x61, 0x74, 0x63, 0x68, 0x12, 0x4b, 0x0a, 0x12, 0x74, 0x73, 0x73, 0x5f, 0x67, 0x6f, 0x73, 0x73,
	0x69, 0x70, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1b, 0x2e, 0x67, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x53, 0x53,
	0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x48, 0x00, 0x52,
	0x10, 0x74, 0x73, 0x73, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x4a, 0x0a, 0x10,
	0x54, 0x53, 0x53, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x72, 0x0a, 0x0f, 0x53, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x68,
	0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09,
	0x68, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x67,
	...
	0x67, 0x75, 0x61, 0x72, 0x64, 0x69, 0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x22, 0xc5, 0x04, 0x0a,
	...
	,
	...
	0x0a, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	0x61, 0x66, 0x65, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0a, 0x73, 0x61, 0x66, 0x65, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x29, 0x0a, 0x10,
	...
	0x64, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x3b, 0x0a, 0x1a, 0x6c, 0x61, 0x73, 0x74, 0x5f,
	0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x17, 0x6c, 0x61, 0x73,
	0x74, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x41, 0x74, 0x22, 0x27, 0x0a, 0x13, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x56, 0x41,
	...
	0x52, 0x0c, 0x67, 0x75, 0x61, 0x72, 0x64, 0x69, 0x61, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x22, 0x66,
	...
	0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x76, 0x0a, 0x19, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64,
	0x43, 0x68, 0x61, 0x69, 0x6e, 0x47, 0x6f, 0x76, 0x65, 0x72, 0x6e, 0x6f, 0x72, 0x43, 0x6f, 0x6e,
...
var file_gossip_v1_gossip_proto_goTypes = []interface{}{
	...
	(*TSSGossipMessage)(nil),                // 1: gossip.v1.TSSGossipMessage
	(*SignedHeartbeat)(nil),                 // 2: gossip.v1.SignedHeartbeat
	(*Heartbeat)(nil),                       // 3: gossip.v1.Heartbeat
	...
	(*SignedObservationBatch)(nil),          // 13: gossip.v1.SignedObservationBatch
	(*Observation)(nil),                     // 14: gossip.v1.Observation
...
var file_gossip_v1_gossip_proto_depIdxs = []int32{
	2,  // 0: gossip.v1.GossipMessage.signed_heartbeat:type_name -> gossip.v1.SignedHeartbeat
	4,  // 1: gossip.v1.GossipMessage.signed_vaa_with_quorum:type_name -> gossip.v1.SignedVAAWithQuorum
	5,  // 2: gossip.v1.GossipMessage.signed_observation_request:type_name -> gossip.v1.SignedObservationRequest
	7,  // 3: gossip.v1.GossipMessage.signed_chain_governor_config:type_name -> gossip.v1.SignedChainGovernorConfig
	9,  // 4: gossip.v1.GossipMessage.signed_chain_governor_status:type_name -> gossip.v1.SignedChainGovernorStatus
	11, // 5: gossip.v1.GossipMessage.signed_query_request:type_name -> gossip.v1.SignedQueryRequest
	12, // 6: gossip.v1.GossipMessage.signed_query_response:type_name -> gossip.v1.SignedQueryResponse
	13, // 7: gossip.v1.GossipMessage.signed_observation_batch:type_name -> gossip.v1.SignedObservationBatch
	1,  // 8: gossip.v1.GossipMessage.tss_gossip_message:type_name -> gossip.v1.TSSGossipMessage
	...
	14, // 13: gossip.v1.SignedObservationBatch.observations:type_name -> gossip.v1.Observation
...
func file_gossip_v1_gossip_proto_init() {
	...
	file_gossip_v1_gossip_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*GossipMessage_TssGossipMessage)(nil),
	}
	type x struct{}
