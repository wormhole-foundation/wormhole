...
var (
	...
	testnetChainConfig = EnvMap{
		// As of 2025 February we use Sepolia as the default Ethereum testnet, given that Goerli is being deprecated.
		...
		// Ethereum Sepolia is now the default for vaa.ChainIDEthereum instead
