...
func (p *Manager[K]) Run(ctx context.Context) error {
	...
	signedInProducer, signedInConsumer := p2p.MeteredBufferedChannelPair[*gossipv1.GossipMessage_SignedObservation](ctx, 100, fmt.Sprintf("manager_%s_signed_observation", p.group))
