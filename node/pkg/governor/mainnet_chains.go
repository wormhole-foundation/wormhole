...
func ChainList() []ChainConfigEntry {
	return []ChainConfigEntry{
		...
		{EmitterChainID: vaa.ChainIDTerra, DailyLimit: 0, BigTransactionSize: 0},
		...
		{EmitterChainID: vaa.ChainIDOasis, DailyLimit: 0, BigTransactionSize: 0},
		...
		{EmitterChainID: vaa.ChainIDKarura, DailyLimit: 0, BigTransactionSize: 0},
		...
		{EmitterChainID: vaa.ChainIDTerra2, DailyLimit: 0, BigTransactionSize: 0},
		...
		{EmitterChainID: vaa.ChainIDSnaxchain, DailyLimit: 0, BigTransactionSize: 0},
