...
var (
	...
	logMessagePublishedTopic = celo_common.HexToHash("0x6eb224fb001ed210e379b335e35efe88672a8ce935d981a6896b27ffdf52a3b2")
)
...
func MessageEventsForTransaction(
	...
	chainId vaa.ChainID,
	tx celo_common.Hash) (uint64, []*common.MessagePublication, error) {
	...
	for _, l := range receipt.Logs {
		...
		message := &common.MessagePublication{
			TxHash:           eth_common.BytesToHash(ev.Raw.TxHash.Bytes()),
