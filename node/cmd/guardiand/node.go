...
func init() {
	...
	plasmaRPC = node.RegisterFlagWithValidationOrFail(NodeCmd, "Plasma", "PLASMA RPC_URL", "ws://eth-devnet:8545", []string{"ws", "wss"})
	plasmaContract = NodeCmd.Flags().String("plasmaContract", "", "Plasma contract address")

	creditCoinRPC = node.RegisterFlagWithValidationOrFail(NodeCmd, "CreditCoin", "CREDITCOIN RPC_URL", "ws://eth-devnet:8545", []string{"ws", "wss"})
