...
func runSpy(cmd *cobra.Command, args []string) {
	...
	supervisor.New(rootCtx, logger, func(ctx context.Context) error {
		...
		if err := supervisor.Run(ctx, "p2p", p2p.Runnable(priv, gst, *p2pNetworkID, *p2pBootstrap, "", components, func(ctx context.Context, gossip *p2p.Gossip) supervisor.Runnable {
