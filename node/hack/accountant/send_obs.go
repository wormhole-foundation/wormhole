...
func main() {
	...
	if !testSubmit(ctx, logger, gk, wormchainConn, contract, "0000000000000000000000009561C133DD8580860B6b7E504bC5Aa500f0f06a7", timestamp, sequence, true, "Submit should succeed") {
		return
	}

	if !testSubmit(ctx, logger, gk, wormchainConn, contract, "0000000000000000000000009561C133DD8580860B6b7E504bC5Aa500f0f06a7", timestamp, sequence, true, "Already commited should succeed") {
		return
	}
...
func testBatch(
	...
	EmitterAddress, _ := vaa.StringToAddress("0000000000000000000000009561C133DD8580860B6b7E504bC5Aa500f0f06a7")
	TxHash, _ := vaa.StringToHash("82ea2536c5d1671830cb49120f94479e34b54596a8dd369fbc2666667a765f4b")
	Payload, _ := hex.DecodeString("")
