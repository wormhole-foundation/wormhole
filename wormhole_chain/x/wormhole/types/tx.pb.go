...
type MsgRegisterAccountAsGuardian struct {
	...
	AddressBech32  string       `protobuf:"bytes,3,opt,name=addressBech32,proto3" json:"addressBech32,omitempty"`
...
func (m *MsgRegisterAccountAsGuardian) GetAddressBech32() string {
	if m != nil {
		return m.AddressBech32
	}
	return ""
}
...
var fileDescriptor_55f7aa067b0c517b = []byte{
	...
	0xa5, 0x8b, 0x8c, 0x5c, 0x32, 0xbe, 0xc5, 0xe9, 0x41, 0xa9, 0xe9, 0x99, 0xc5, 0x25, 0xa9, 0x45,
	...
	,
}
...
func (m *MsgRegisterAccountAsGuardian) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AddressBech32) > 0 {
		i -= len(m.AddressBech32)
		copy(dAtA[i:], m.AddressBech32)
		i = encodeVarintTx(dAtA, i, uint64(len(m.AddressBech32)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *MsgRegisterAccountAsGuardian) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddressBech32", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddressBech32 = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
