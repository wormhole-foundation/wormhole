...
const baseTokenRegistration: object = { index: "" };

export const TokenRegistration = {
  encode(message: TokenRegistration, writer: Writer = Writer.create()): Writer {
    if (message.index !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): TokenRegistration {
    ...
    const message = { ...baseTokenRegistration } as TokenRegistration;
