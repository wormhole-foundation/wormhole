...
export declare const EventChainRegistered: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): EventChainRegistered;
...
export declare const EventAssetRegistrationUpdate: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): EventAssetRegistrationUpdate;
...
export declare const EventTransferReceived: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): EventTransferReceived;
