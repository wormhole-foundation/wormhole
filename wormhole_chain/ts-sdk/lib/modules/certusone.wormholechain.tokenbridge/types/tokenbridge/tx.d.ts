...
export declare const MsgExecuteGovernanceVAA: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgExecuteGovernanceVAA;
...
export declare const MsgExecuteGovernanceVAAResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgExecuteGovernanceVAAResponse;
...
export declare const MsgExecuteVAA: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgExecuteVAA;
...
export declare const MsgExecuteVAAResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgExecuteVAAResponse;
...
export declare const MsgAttestToken: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgAttestToken;
...
export declare const MsgAttestTokenResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgAttestTokenResponse;
