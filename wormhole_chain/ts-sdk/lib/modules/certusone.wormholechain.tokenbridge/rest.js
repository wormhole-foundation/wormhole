...
var Api = /** @class */ (function (_super) {
    ...
    function Api() {
         ...
         */
        _this.queryChainRegistrationAll = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/chainRegistration", method: "GET", query: query, format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.queryChainRegistration = function (chainID, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/chainRegistration/".concat(chainID), method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.queryCoinMetaRollbackProtectionAll = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/coinMetaRollbackProtection", method: "GET", query: query, format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.queryCoinMetaRollbackProtection = function (index, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/coinMetaRollbackProtection/".concat(index), method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
        ...
        _this.queryConfig = function (params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/config", method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
        ...
        _this.queryReplayProtectionAll = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/replayProtection", method: "GET", query: query, format: "json" }, params));
        };
        /**
         * No description
         *
        ...
        _this.queryReplayProtection = function (index, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/certusone/wormholechain/tokenbridge/replayProtection/".concat(index), method: "GET", format: "json" }, params));
        };
        return _this;
    }
    return Api;
