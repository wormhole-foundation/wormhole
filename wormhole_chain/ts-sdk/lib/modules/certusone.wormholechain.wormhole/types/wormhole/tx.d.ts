...
export declare const MsgRegisterAccountAsGuardian: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgRegisterAccountAsGuardian;
...
export declare const MsgRegisterAccountAsGuardianResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): MsgRegisterAccountAsGuardianResponse;
