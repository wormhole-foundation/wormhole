...
export declare const GuardianSetUpdateProposal: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): GuardianSetUpdateProposal;
...
export declare const GovernanceWormholeMessageProposal: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): GovernanceWormholeMessageProposal;
