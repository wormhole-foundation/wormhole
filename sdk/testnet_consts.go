...
var (
	KnownTestnetTokenbridgeEmitters = buildEmitterMap(knownTestnetTokenbridgeEmitters)
	knownTestnetTokenbridgeEmitters = map[vaa.ChainID]string{
...
var (
	KnownTestnetNFTBridgeEmitters = buildEmitterMap(knownTestnetNFTBridgeEmitters)
	knownTestnetNFTBridgeEmitters = map[vaa.ChainID]string{
