...
var knownDevnetTokenbridgeEmitters = map[vaa.ChainID]string{
	...
	vaa.ChainIDSui:       "7b19543ac266fd13aa5f37421251fdbd2076a266785cf2c21d88199bee1c7d45",
}
...
// KnownDevnetXRPLSequencer is the known XRPL sequencer emitter used during development.
var KnownDevnetXRPLSequencer = struct {
	ChainId vaa.ChainID
	Addr    string
