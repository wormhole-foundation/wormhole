import { ErrNotWrapped, UniversalAddress, chainIdToChain, keccak256, serialize, toChainId, toNative, } from '@wormhole-foundation/connect-sdk';
import { ethers_contracts } from '.';
import { EvmAddress, EvmPlatform, EvmUnsignedTransaction, EvmZeroAddress, addChainId, addFrom, evmNetworkChainToEvmChainId, unusedArbiterFee, unusedNonce, } from '@wormhole-foundation/connect-sdk-evm';
export class EvmTokenBridge {
    ...
    async *createAttestation(token) {
        ...
        yield this.createUnsignedTx(await this.tokenBridge.attestToken.populateTransaction(new EvmAddress(token).toString(), ignoredNonce), 'TokenBridge.createAttestation');
    }
