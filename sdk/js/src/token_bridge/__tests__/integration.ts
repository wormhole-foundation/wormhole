        ...
        test.only("Send Ethereum ERC-20 to Solana", (done) => {
            (async () => {
                try {
                    ...
                    expect(
                        finalSolanaBalance - initialSolanaBalance === 1
                    ).toBe(true);
                    provider.destroy();
                    done();
                } catch (e) {
        ...
        test.only("Send Solana SPL to Ethereum", (done) => {
            (async () => {
                try {
                    ...
                    const initialBalOnEthFormatted = formatUnits(
                    ...
                    // console.log("Final Solana balance:", finalSolanaBalance);
                    expect(
                        initialSolanaBalance - finalSolanaBalance
                    ).toBeCloseTo(1);
                    ...
                    const finalBalOnEthFormatted = formatUnits(
                        finalBalOnEth._hex,
                        9
                    );
                    // console.log(
        ...
        test.only("Send Ethereum ERC-20 to Terra", (done) => {
            (async () => {
                try {
                    ...
                    let cw20BalOnTerra: Erc20Balance =
                        await lcd.wasm.contractQuery(foreignAsset, {
                            balance: {
                    ...
                    let finalBalOnEthStr = ethers.utils.formatUnits(
                        finalBalOnEth,
                        18
                    );
                    console.log(
                    ...
                    cw20BalOnTerra = await lcd.wasm.contractQuery(
                        foreignAsset,
                        {
                            balance: {
                                address: TerraWalletAddress,
        ...
        test("Transfer CW20 token from Terra to Ethereum and back again", (done) => {
            (async () => {
                try {
                    ...
                    let initialCW20BalOnEthInt = parseInt(
                        initialCW20BalOnEth._hex
                    );
                    console.log(
                    ...
                    let cw20BalOnTerra: Cw20Balance =
                        await lcd.wasm.contractQuery(CW20, {
                            balance: {
                                address: TerraWalletAddress,
                            },
                        });
                    ...
                    expect(
                        initialCW20BalOnEthInt + 1e6 === finalCW20BalOnEthInt
                    ).toBe(true);
                    ...
                    expect(
                        initialCW20BalOnTerra - finalCW20BalOnTerra === 1
                    ).toBe(true);
                    ...
                    finalCW20BalOnEth = await token.balanceOf(
                        ETH_TEST_WALLET_PUBLIC_KEY
                    );
                    ...
                    expect(
                        finalCW20BalOnTerra - initialCW20BalOnTerra === 1
                    ).toBe(true);
                    // Done checking wallet balances
                } catch (e) {
