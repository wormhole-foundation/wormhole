...
import { BpfLoaderUpgradeable, deriveBpfLoaderUpgradeable } from "../../utils";
...
export function getUpgradeContractAccounts(
  ...
  return {
    ...
    upgradeAuthority: deriveUpgradeKey(nftBridgeProgramId),
    spill: new PublicKey(spill),
    newContract: new PublicKey(parsed.newContract),
    programData: deriveBpfLoaderUpgradeable(nftBridgeProgramId),
    tokenBridgeProgram: new PublicKey(nftBridgeProgramId),
    rent: SYSVAR_RENT_PUBKEY,
