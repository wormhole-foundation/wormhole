...
func TestChainIDFromString(t *testing.T) {
	...
	p_tests := []test{
		...
		{input: "codex", output: ChainIDCodex},
		{input: "plume", output: ChainIDPlume},
		{input: "aztec", output: ChainIDAztec},
...
func TestChainId_String(t *testing.T) {
	...
	tests := []test{
		...
		{input: 54, output: "codex"},
		{input: 55, output: "plume"},
		{input: 56, output: "aztec"},
