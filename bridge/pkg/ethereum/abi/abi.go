...
//
// Solidity: function parseAndVerifyVM(bytes encodedVM) view returns((uint8,uint32,uint32,uint16,bytes32,uint64,bytes,uint32,(bytes32,bytes32,uint8,uint8)[],bytes32) vm, bool valid, string reason)
...
//
// Solidity: function parseSetMessageFee(bytes encodedSetMessageFee) pure returns((bytes32,uint8,uint16,uint256,uint256) smf)
...
//
// Solidity: function parseVM(bytes encodedVM) pure returns((uint8,uint32,uint32,uint16,bytes32,uint64,bytes,uint32,(bytes32,bytes32,uint8,uint8)[],bytes32) vm)
...
// PersistedMessageFee is a free data retrieval call binding the contract method 0x9d65ceb3.
//
// Solidity: function persistedMessageFee() view returns(uint256)
func (_Abi *AbiCaller) PersistedMessageFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "persistedMessageFee")
...
//
// Solidity: function persistedMessageFee() view returns(uint256)
func (_Abi *AbiSession) PersistedMessageFee() (*big.Int, error) {
	return _Abi.Contract.PersistedMessageFee(&_Abi.CallOpts)
}

// PersistedMessageFee is a free data retrieval call binding the contract method 0x9d65ceb3.
//
// Solidity: function persistedMessageFee() view returns(uint256)
func (_Abi *AbiCallerSession) PersistedMessageFee() (*big.Int, error) {
	return _Abi.Contract.PersistedMessageFee(&_Abi.CallOpts)
}
...
// VerifyVM is a free data retrieval call binding the contract method 0x55553ce4.
//
// Solidity: function verifyVM((uint8,uint32,uint32,uint16,bytes32,uint64,bytes,uint32,(bytes32,bytes32,uint8,uint8)[],bytes32) vm) view returns(bool valid, string reason)
...
// PublishMessage is a paid mutator transaction binding the contract method 0x12ec0706.
//
// Solidity: function publishMessage(uint32 nonce, bytes payload, bool persistMessage) payable returns()
func (_Abi *AbiTransactor) PublishMessage(opts *bind.TransactOpts, nonce uint32, payload []byte, persistMessage bool) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "publishMessage", nonce, payload, persistMessage)
}

// PublishMessage is a paid mutator transaction binding the contract method 0x12ec0706.
//
// Solidity: function publishMessage(uint32 nonce, bytes payload, bool persistMessage) payable returns()
func (_Abi *AbiSession) PublishMessage(nonce uint32, payload []byte, persistMessage bool) (*types.Transaction, error) {
	return _Abi.Contract.PublishMessage(&_Abi.TransactOpts, nonce, payload, persistMessage)
}

// PublishMessage is a paid mutator transaction binding the contract method 0x12ec0706.
//
// Solidity: function publishMessage(uint32 nonce, bytes payload, bool persistMessage) payable returns()
func (_Abi *AbiTransactorSession) PublishMessage(nonce uint32, payload []byte, persistMessage bool) (*types.Transaction, error) {
	return _Abi.Contract.PublishMessage(&_Abi.TransactOpts, nonce, payload, persistMessage)
}
...
// FilterLogMessagePublished is a free log retrieval operation binding the contract event 0xc9a92c42c67447ff46e5a94fb7e50d0edae258f18b78ce74ebbb1ffc5cb1e177.
//
// Solidity: event LogMessagePublished(address indexed sender, uint64 sequence, uint32 nonce, bytes payload, bool persistMessage)
...
// WatchLogMessagePublished is a free log subscription operation binding the contract event 0xc9a92c42c67447ff46e5a94fb7e50d0edae258f18b78ce74ebbb1ffc5cb1e177.
//
// Solidity: event LogMessagePublished(address indexed sender, uint64 sequence, uint32 nonce, bytes payload, bool persistMessage)
...
// ParseLogMessagePublished is a log parse operation binding the contract event 0xc9a92c42c67447ff46e5a94fb7e50d0edae258f18b78ce74ebbb1ffc5cb1e177.
//
// Solidity: event LogMessagePublished(address indexed sender, uint64 sequence, uint32 nonce, bytes payload, bool persistMessage)
