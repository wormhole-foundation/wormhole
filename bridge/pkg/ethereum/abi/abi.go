...
// PublishMessage is a paid mutator transaction binding the contract method 0x3747d238.
//
// Solidity: function publishMessage(uint32 nonce, bytes payload, bool persistMessage, uint8 commitment) payable returns()
func (_Abi *AbiTransactor) PublishMessage(opts *bind.TransactOpts, nonce uint32, payload []byte, persistMessage bool, commitment uint8) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "publishMessage", nonce, payload, persistMessage, commitment)
}

// PublishMessage is a paid mutator transaction binding the contract method 0x3747d238.
//
// Solidity: function publishMessage(uint32 nonce, bytes payload, bool persistMessage, uint8 commitment) payable returns()
func (_Abi *AbiSession) PublishMessage(nonce uint32, payload []byte, persistMessage bool, commitment uint8) (*types.Transaction, error) {
	return _Abi.Contract.PublishMessage(&_Abi.TransactOpts, nonce, payload, persistMessage, commitment)
}

// PublishMessage is a paid mutator transaction binding the contract method 0x3747d238.
//
// Solidity: function publishMessage(uint32 nonce, bytes payload, bool persistMessage, uint8 commitment) payable returns()
func (_Abi *AbiTransactorSession) PublishMessage(nonce uint32, payload []byte, persistMessage bool, commitment uint8) (*types.Transaction, error) {
	return _Abi.Contract.PublishMessage(&_Abi.TransactOpts, nonce, payload, persistMessage, commitment)
}
...
// FilterLogMessagePublished is a free log retrieval operation binding the contract event 0x10ac5d8d56b7b649d55310c31e67148c731c63a7ed9c7a074e92befdedce3051.
//
// Solidity: event LogMessagePublished(address indexed sender, uint64 sequence, uint32 nonce, bytes payload, bool persistMessage, uint8 commitment)
...
// WatchLogMessagePublished is a free log subscription operation binding the contract event 0x10ac5d8d56b7b649d55310c31e67148c731c63a7ed9c7a074e92befdedce3051.
//
// Solidity: event LogMessagePublished(address indexed sender, uint64 sequence, uint32 nonce, bytes payload, bool persistMessage, uint8 commitment)
...
// ParseLogMessagePublished is a log parse operation binding the contract event 0x10ac5d8d56b7b649d55310c31e67148c731c63a7ed9c7a074e92befdedce3051.
//
// Solidity: event LogMessagePublished(address indexed sender, uint64 sequence, uint32 nonce, bytes payload, bool persistMessage, uint8 commitment)
