...
/// This code is adapted from the Wormhole Sui token bridge:
/// https://github.com/wormhole-foundation/wormhole/blob/main/sui/nft_bridge/sources/resources/token_registry.move
...
module nft_bridge::token_registry {
    ...
    use nft_bridge::asset_meta::{Self, AssetMeta};
    use nft_bridge::native_asset::{Self, NativeAsset};
    use nft_bridge::wrapped_asset::{Self, WrappedAsset};

    // friend nft_bridge::attest_token;
    // friend nft_bridge::complete_transfer;
    // friend nft_bridge::create_wrapped;
    // friend nft_bridge::state;
    // friend nft_bridge::transfer_tokens;
    ...
    public(friend) fun add_new_wrapped<CoinType>(
        ...
        coin_meta: &mut Display<CoinType>,
        treasury_cap: TreasuryCap<CoinType>, // TODO - change this to publisher?
    ...
    public fun add_new_wrapped_test_only<CoinType>(
        ...
        add_new_wrapped(
            ...
            sui::package::test_publish(
                object::id_from_address(@nft_bridge),
                ctx
            )
        )
    }
...
#[test_only]
module nft_bridge::token_registry_tests {
    use std::type_name::{Self};
    ...
    use nft_bridge::asset_meta::{Self};
    use nft_bridge::coin_native_10::{Self, COIN_NATIVE_10};
    use nft_bridge::coin_wrapped_7::{Self, COIN_WRAPPED_7};
    use nft_bridge::native_asset::{Self};
    use nft_bridge::token_registry::{Self};
    use nft_bridge::nft_bridge_scenario::{person};
    use nft_bridge::wrapped_asset::{Self};
