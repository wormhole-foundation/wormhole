...
describe("Core Relayer Integration Test - Two Chains", () => {
  ...
  it("Test governance actions", async () => {
    ...
    let tx = await sourceCoreRelayer.registerCoreRelayerContract(Buffer.from("", "hex"), {gasLimit: 500000});
    await tx.wait();
    ...
    tx = await sourceCoreRelayer.setDefaultRelayProvider(Buffer.from("", "hex"), {gasLimit: 500000});
    await tx.wait();
