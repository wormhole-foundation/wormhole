...
# TODO:
# This script is very similar to verifyWormholeRelayer.sh, but it only verifies the implementation contract
...
set last_run_file "ts-scripts/relayer/output/$ENV/deployWormholeRelayerImplementation/lastrun.json"
