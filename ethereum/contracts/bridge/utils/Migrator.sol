...
contract Migrator is ERC20 {
    ...
    uint256 public fromDecimals;
    uint256 public toDecimals;

    constructor(address _fromAsset, address _toAsset)
    ...
    function claim(uint256 _amount) external {
        ...
        SafeERC20.safeTransfer(
            fromAsset,
            msg.sender,
            adjustDecimals(toDecimals, fromDecimals, _amount)
        );
    }
    ...
    function migrate(uint256 _amount) external {
        ...
        SafeERC20.safeTransfer(
            toAsset,
            msg.sender,
            adjustDecimals(fromDecimals, toDecimals, _amount)
        );
    }
