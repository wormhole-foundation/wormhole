...
export CORE_CONTRACT_FILES='./contracts/Implementation.sol ./contracts/mock/MockBatchedVAASender.sol ./contracts/mock/MockImplementation.sol ./contracts/Messages.sol ./contracts/Wormhole.sol ./contracts/interfaces/IWormhole.sol ./contracts/Setup.sol ./contracts/GovernanceStructs.sol ./contracts/Getters.sol ./contracts/Structs.sol ./contracts/Governance.sol ./contracts/Migrations.sol ./contracts/Setters.sol ./contracts/Shutdown.sol ./contracts/State.sol'
