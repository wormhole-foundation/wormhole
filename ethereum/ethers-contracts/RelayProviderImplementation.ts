...
export interface RelayProviderImplementationInterface extends utils.Interface {
  functions: {
...
export interface RelayProviderImplementation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RelayProviderImplementationInterface;
