...
export interface CoreRelayerGovernanceInterface extends utils.Interface {
  functions: {
...
export interface CoreRelayerGovernance extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoreRelayerGovernanceInterface;
