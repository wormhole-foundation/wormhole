...
export interface WormholeRelayerGovernanceTestsInterface
  ...
  functions: {
    ...
    "testSetDefaultRelayProvider()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "setUp"
      | "testRegisterChain"
      | "testSetDefaultRelayProvider"
      | "testUpgradeContractToItself"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testRegisterChain",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSetDefaultRelayProvider",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testUpgradeContractToItself",
    values?: undefined
  ): string;
...
export interface WormholeRelayerGovernanceTests extends BaseContract {
  ...
  callStatic: {
    ...
    testSetDefaultRelayProvider(overrides?: CallOverrides): Promise<void>;
