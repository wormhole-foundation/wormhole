...
export interface MockGenericRelayerInterface extends utils.Interface {
  functions: {
    ...
    "relay((bytes32[],bytes)[],uint16,bytes)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "relay(uint16,bytes)"
      | "relay(uint16)"
      | "relay((bytes32[],bytes)[],uint16,bytes)"
  ...
  encodeFunctionData(
    functionFragment: "relay(uint16,bytes)",
  ...
  encodeFunctionData(
    functionFragment: "relay((bytes32[],bytes)[],uint16,bytes)",
    values: [
      Vm.LogStruct[],
