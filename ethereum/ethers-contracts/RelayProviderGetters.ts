...
export interface RelayProviderGettersInterface extends utils.Interface {
  functions: {
...
export interface RelayProviderGetters extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RelayProviderGettersInterface;
