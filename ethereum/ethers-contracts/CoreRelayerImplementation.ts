...
export interface CoreRelayerImplementationInterface extends utils.Interface {
  functions: {
...
export interface CoreRelayerImplementation extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoreRelayerImplementationInterface;
