...
export interface TestDeliveryProviderInterface extends utils.Interface {
  functions: {
    ...
    "testCanUpdatePriceOnlyAsOwner(address,uint16,uint256,uint256)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "testUpdatePrice"
      | "testUpdateRewardAddress"
      | "testUpdateTargetChainContracts"
      | "vm"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testBulkUpdatePrices",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "testUpdateRewardAddress",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "testUpdateTargetChainContracts",
