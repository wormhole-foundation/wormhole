...
export const MAX_WRAPPED_COIN_DECIMALS = 8;

/** Compiled module up to (and excluding) the spliced token bridge package ID. */
export const WRAPPED_COIN_BYTECODE_PREFIX =
...
export const WRAPPED_COIN_BYTECODE_BEFORE_DECIMALS =
  "00020106010000000001090b0031";

/** Fixed bytes following the decimals byte (the remainder of `init`). */
export const WRAPPED_COIN_BYTECODE_AFTER_DECIMALS =
