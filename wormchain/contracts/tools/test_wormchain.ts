...
async function main() {
    ...
    const emitter_address = "0000000000000000000000009561C133DD8580860B6b7E504bC5Aa500f0f06a7"
    const observations = [
        {
            emitter_chain: 2,
            ...
            timestamp: 1,
            payload:
                Buffer.from("", "hex").toString("base64"),
