...
export const ReplayProtection = {
  encode(message: ReplayProtection, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<ReplayProtection>, I>>(object: I): ReplayProtection {
    const message = createBaseReplayProtection();
