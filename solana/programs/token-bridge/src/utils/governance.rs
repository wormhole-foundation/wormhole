...
use core_bridge_program::{error::CoreBridgeError, state::PartialPostedVaaV1};
...
pub(crate) const GOVERNANCE_DECREE_START: usize = PartialPostedVaaV1::PAYLOAD_START + 32 + 1;
