...
//!
//! As of this writing (March, 2022) there is no proper specification for the VAA payload wire
...
//! ### `&str`, `String`
//!
//! String types are not currently supported though they could be easily supported by treating them
//! as byte arrays with a restriction that the byte array must be valid UTF-8.
//!
//! ### Tuples
//!
...
//! ### Map types
//!
//! Map types are not currently supported. However they can be easily supported by encoding them as
    ...
    fn end_to_end() {
        let vaa = Vaa {
            ...
            payload: GovernancePacket {
                ...
                chain: Chain::Solana,
                payload: Cow::Borrowed(&[0x3d, 0xab, 0x45, 0xaf, 0x7a, 0x6e, 0x9f, 0x7b]),
            },
        };
