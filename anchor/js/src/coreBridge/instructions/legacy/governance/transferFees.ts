...
export class LegacyTransferFeesContext {
  payer: PublicKey;
  bridge: PublicKey;
  postedVaa: PublicKey;
  claim: PublicKey;
  ...
  static new(
    ...
    return new LegacyTransferFeesContext(programId, payer, hash, vaaInfo);
  }
  ...
  static instruction(
    ...
    return legacyTransferFeesIx(
      programId,
      LegacyTransferFeesContext.new(programId, payer, hash, vaaInfo)
    );
  }
}
